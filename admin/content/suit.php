...
if($_REQUEST['prid']==1)
{
     ...
     <div class="right_panel">
        ...
        <div class="logo_info" id="image_head">
         <p id="item_image1">Salwar Suit Management</p>
       <a onclick="history.back(); return false;" href="#">
           ...
           <span style="float:right;margin-right:140px;"> <a href="dashboard.php?page=suit&prid=2" > Add Suit</a> </span>              
</div>
         <!-- table starts -->
      <div class="table_box">
    	    <!-- ADD link 
...
<img src="resize.php?w=100&h=100&img=../../<?php echo $info['path_to_file']; ?>" title="<?php echo $info['title'];?>" alt='' />	  
      ...
      <td valign="top" >
		 <a href="dashboard.php?page=suit&prid=2&x=<?php echo $id ?>" /> <img src="../images/edit.png" alt="Edit" title="Edit"> </a> |
...
<div class="bottom">
     ...
     <a onclick="history.back(); return false;" href="#">
      ...
      <form name="entry_form" id="entry_form" action="dashboard.php?page=suit&prid=3"  method="post" enctype="multipart/form-data">
      
<table width="70%" border="0" align="center">
  <tr>
    <td height="30" colspan="4" class="strip1">SALWAR SUIT INFORMATION</td>
  </tr>
<tr>
...
<table width="100%" border="1" align="center" style="border:0px;!important;">
  ...
  <tr>
    ...
    <td width="60"><?php $fnc->getProductMaterial('material',$info['material'],2,'required','235px'); ?></td>
  </tr>  
  <tr>
  ...
  <tr>
    ...
    <td width="60"><?php $fnc->getProductColor('color',$info['color'],2,'required','235px'); ?></td>
  </tr>   
  <tr>
...
<td width="30%;">
<img src="<?php if($info['path_to_file']!='') echo '../../'.$info['path_to_file'];else echo '../../images/suit/su1.jpeg';?>" alt="" width="350" height="330" id="img_prev">
...
if($file_img!="")
{
			...
			$filepath= "../../uploads/suit/".$new_file_name.basename( $_FILES['image']['name']);
			$path_to_file= "uploads/suit/".$new_file_name.basename( $_FILES['image']['name']);
...
$path_to_file=htmlspecialchars(mysql_escape_string($_POST['hidden_path_to_file']));	
	if($action=="add")
	{
 		$sql="INSERT INTO tbl_suit (product_code,title,material,price,color,purpose,description,meta_keywords,
	...
	?>
		...
		alert(msg);
		window.location="dashboard.php?page=suit&prid=1";
		</script>
<?php		
}
/* Delete the record */
