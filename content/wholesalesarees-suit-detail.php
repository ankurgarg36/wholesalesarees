...
$info=mysql_fetch_array(mysql_query("SELECT * from tbl_suit WHERE product_code='$product_code'"));
...
<div class="grid_12">
	...
	<?php
$query=mysql_query("SELECT * FROM tbl_suit WHERE material='$info[material]' and product_code!='$product_code' order by created_date LIMIT 10");
$i=1;
...
?>
		<div class="product_box">
				<div class="thumb_wrapper_detail">
					<a href="index.php?page=wholesalesarees-suit-detail&product_code=<?php echo $res['product_code'];?>">
					...
					<p class="pro-info"><?php echo substr($res['title'],0,40);?> <a href="index.php?page=wholesalesarees-suit-detail&product_code=<?php echo $res['product_code'];?>"  style="color:red;">Read More..</a></p>
