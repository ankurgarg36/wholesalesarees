...
$info = mysqli_fetch_array(mysqli_query($link, "SELECT * from tbl_saree WHERE product_code='" . $_REQUEST['product_code'] . "'"));
            ...
            <div class="grid_12 alpha">
                ...
                <div class="zoom-section">
                    <div class="zoom-small-image">
                        <a href="/resize.php?w=768&h=1024&img=<?php echo $info['path_to_file']; ?>" class='cloud-zoom'
                           rel="tint:'#ff0000',tintOpacity:0.5,smoothMove:5,zoomWidth:480,adjustY:-4,adjustX:10">
                            <img src="resize.php?w=320&h=480&img=<?php echo $info['path_to_file']; ?>"
                                    title="<?php echo $info['title']; ?>" alt="<?php echo $info['title']; ?>"/></a>
                    </div>
                ...
                <div class="tour">
                    <div class="extra_wrapper">
                        ...
                        <p class="price">Best Price:<span>Rs. <?php echo money_format('%!i', $info['price']); ?></span>
                        </p>
                    ...
                    while ($res = mysqli_fetch_array($query)) {
                        ...
                        <div class="product_box">
                            <div class="thumb_wrapper_detail">
                                <a href="index.php?page=wholesalesarees-saree-detail&product_code=<?php echo $res['product_code']; ?>">
                                    <img src="resize.php?w=200&h=240&img=<?php echo $res['path_to_file']; ?>"
                                         title="<?php echo $res['title']; ?>" alt="<?php echo $res['title']; ?>"/>
                                </a>
                                <div class="price_inner_tag">Rs. <?php echo money_format('%!i', $res['price']); ?></div>
                                <p class="pro-info"><?php echo substr($res['title'], 0, 40); ?> <a
                                            href="index.php?page=wholesalesarees-saree-detail&product_code=<?php echo $res['product_code']; ?>"
                                            style="color:red;">Read More..</a></p>
