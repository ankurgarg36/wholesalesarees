...
?>
		<div class="product_box">
				<div class="thumb_wrapper_detail">
					...
					<p class="pro-info"><?php echo substr($res['title'],0,40);?> <a href="index.php?page=wholesalesarees-saree-detail&product_code=<?php echo $res['product_code'];?>"  style="color:red;">Read More..</a></p>
