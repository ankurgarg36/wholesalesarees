...
$info=mysql_fetch_array(mysql_query("SELECT * from tbl_lengha WHERE product_code='$product_code'"));
...
<div class="grid_12">
	...
	<?php
$query=mysql_query("SELECT * FROM tbl_lengha WHERE material='$info[material]' and product_code!='$product_code' order by created_date LIMIT 10");
$i=1;
